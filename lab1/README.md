Это самая муторная лаботаторная работа, которая проверяет ваши познания в рекурсии, аккумуляторах и каррировании. 
Если придумаете вариант получше, с радостью обсужу.
...
Варианты задания в соответствии с общим полученным вариантом указаны в таблице 1.
...
Помните про то, что язык Haskell строгий, поэтому используйте приведение типов 
